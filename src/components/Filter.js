...
import {faFilter, faFastBackward,faStepBackward,faStepForward,faFastForward} from '@fortawesome/free-solid-svg-icons'
const Filter = (props) => {
        ...
        if (props.dataRes.totalItems !== 0) {
            ...
            pageNumbers.push(
                <li key="first" className={'page-item'}>
                    <button className="page-link" onClick={() => handleClickButtonPage('')}>
                    <FontAwesomeIcon icon={faFilter} /> Hôm Nay
                    </button>
                </li>
            );
            // Trang đầu tiên
