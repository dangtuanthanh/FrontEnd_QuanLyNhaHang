...
// dùng để reset khi bấm nút quay lại
    ...
    function handleSelectAllChange(event) {
        ...
        if (isChecked) {
            ...
            const allIds = props.duLieuHienThi.map((item) => item.IDBan.toString());
        ...
        <table class="table align-items-center mb-0">
            <thead>
                <tr >
                    ...
                    <th style={{ padding: 8 }} onClick={() => handleClickSort('TrangThai')} class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-10">Trạng Thái </th>
                    <th style={{ padding: 8 }} class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-10">Ghi Chú</th>
                    <th style={{ padding: 8 }} onClick={() => handleClickSort('TenKhuVuc')} class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-10">Vị Trí Bàn</th>
                        ...
                        onClick={() => {
                            ...
                            <td >
                                <input
                                    ...
                                    checked={props.selectedIds.includes(dulieu.IDBan.toString())}
                            ...
                            <td style={{ textAlign: 'left' }} >{dulieu.TrangThai}</td>
