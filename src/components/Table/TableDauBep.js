...
const TableDauBep = (props) => {
    ...
    const handleSubmit = (IDHoaDon, IDSanPham, IDTrangThai,TrangThaiMonHienTai,SoLuong) => {
            ...
            <tbody>
                {
                    props.duLieuHienThi.map((dulieu, index) =>
                        ...
                        >
                            ...
                            <td>
                                <a onClick={() => {
                                    handleSubmit(dulieu.IDHoaDon, dulieu.IDSanPham, 2,dulieu.IDTrangThai,dulieu.SoLuong)
                                }} style={{ color: 'green' }} >
                                ...
                                ㅤ
                                <a onClick={() => {
                                    handleSubmit(dulieu.IDHoaDon, dulieu.IDSanPham, 4,dulieu.IDTrangThai,dulieu.SoLuong)
                                }} style={{ color: 'red' }}  >
                                    <i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true" />
                                    < FontAwesomeIcon icon={faBan} />
                                    {/* < FontAwesomeIcon icon={faPencil}style={{color:'cb0c9f'}} /> */}</a>
