...
// dùng để reset khi bấm nút quay lại
    ...
    function handleSelectAllChange(event) {
        ...
        if (isChecked) {
            ...
            const allIds = props.duLieuHienThi.map((item) => item.IDNhanVien.toString());
            ...
            <tbody>
                {
                    props.duLieuHienThi.map((dulieu, index) =>
                        ...
                        <tr style={{ 'textAlign': 'center' }} id='trdata' key={dulieu.IDNhanVien} onClick={() => {
                            ...
                            <td >
                                <input
                                    type="checkbox"
                                    value={dulieu.IDNhanVien}
                                    className='checkboxCon'
                                    checked={props.selectedIds.includes(dulieu.IDNhanVien.toString())}
                            ...
                            <td>
                                ...
                                <a onClick={(e) => {
                                    e.stopPropagation(); props.openPopupAlert(
                                        `Bạn có chắc chắn muốn xoá ${dulieu.TenNhanVien}? Một số ràng buộc liên quan đến dữ liệu này sẽ bị mất dẫn đến việc hiển thị dữ liệu không chính xác!`,
