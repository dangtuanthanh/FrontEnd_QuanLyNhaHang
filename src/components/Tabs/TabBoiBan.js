...
import { urlGetOrder, urlDeleteTypeProduct } from "../url";
import ItemsPerPage from "../ItemsPerPage";
import TableBoiBan from "../Table/TableBoiBan";
function TabBoiBan() {
    //xử lý redux
    ...
    const TaiDuLieu =()=>{
        ...
        fetch(`${urlGetOrder}?status=2&status2=4&page=${dataUser.page}&limit=${dataUser.limit}&sortBy=${dataUser.sortBy}&sortOrder=${dataUser.sortOrder}&search=${dataUser.search}&searchBy=${dataUser.searchBy}&searchExact=${dataUser.searchExact}`, {
            method: 'GET',
            headers: {
