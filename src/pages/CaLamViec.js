...
import { faUser, faTimes, faBars, faClipboardCheck, faSignOut, faClock } from '@fortawesome/free-solid-svg-icons'
...
import TabChotCa from "../components/Tabs/TabChotCa";
import TabCaLamViec from "../components/Tabs/TabCaLamViec";
                                ...
                                <div style={{ marginLeft: '0px' }} className="row">
                                    <ul class="nav nav-tabs col-6">
                                        ...
                                        <li class="nav-item">
                                            <button
                                                style={{ color: '#ff8c00' }}
                                                className={activeTab === 'TabChotCa' ? 'nav-link active' : 'nav-link'}
                                        ...
                                        <li class="nav-item">
                                            <button
                                                style={{ color: '#ff8c00' }}
                                                className={activeTab === 'TabCaLamViec' ? 'nav-link active' : 'nav-link'}
