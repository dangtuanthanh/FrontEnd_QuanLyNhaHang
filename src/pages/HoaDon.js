...
import { faUser, faTimes, faBars, faSignOut, faFileInvoice } from '@fortawesome/free-solid-svg-icons'
...
import TabHoaDon from "../components/Tabs/TabHoaDon";
                                ...
                                <div style={{ marginLeft: '0px' }} className="row">
                                    <ul class="nav nav-tabs col-6">
                                        ...
                                        <li class="nav-item">
                                            <button
                                            style={{ color: '#ff8c00' }}
                                                className={activeTab === 'TabHoaDon' ? 'nav-link active' : 'nav-link'}
