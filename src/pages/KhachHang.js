...
import { faUser, faTimes, faBars, faSignOut, faUserFriends } from '@fortawesome/free-solid-svg-icons'
...
import TabKhachHang from "../components/Tabs/TabKhachHang";
                                ...
                                <div style={{ marginLeft: '0px' }} className="row">
                                    <ul class="nav nav-tabs col-6">
                                        ...
                                        <li class="nav-item">
                                            <button
                                                style={{ color: '#ff8c00' }}
                                                className={activeTab === 'TabKhachHang' ? 'nav-link active' : 'nav-link'}
